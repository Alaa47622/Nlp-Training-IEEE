...
def main():
    ...
    parser.add_argument("--data", default="data/arabic_reviews.csv")
    parser.add_argument("--text-col", default=None)
    parser.add_argument("--label-col", default=None)
    parser.add_argument("--output", default="models/Arabic_model_weights.pkl")
    ...
    X = df[text_col].astype(str).map(preprocess_arabic)
